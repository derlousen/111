...
class EvDataset(Dataset):
    ...
    def __init__(self, transform, pickle_data, data_len, is_train=0):
        ...
        self.prefix = '/home/ev_ai/dms_data/r_net/'
...
if __name__ == "__main__":
    ...
    f = open('/home/ev_ai/dms_data/pickle_gen/data_file_r.p', 'rb')
    print('openning file')
    ...
    data_processor = EvDataset(transform=transform1, pickle_data=data_list, data_len=data_len)
